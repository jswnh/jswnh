...
export const NoiseBackground = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "group relative overflow-hidden rounded-2xl bg-purple-100/50 p-2 backdrop-blur-sm dark:bg-[#1a1130]/90 border border-primary/20",
        "shadow-[0px_0.5px_1px_0px_rgba(110,86,207,0.15)_inset,0px_1px_0px_0px_rgba(255,255,255,0.6)]",
        "dark:shadow-[0px_1px_0px_0px_rgba(110,86,207,0.3)_inset,0px_1px_0px_0px_rgba(0,0,0,0.5)]",
        backdropBlur &&
